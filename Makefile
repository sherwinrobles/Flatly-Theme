...
CROOGO_LESS = ./webroot/less/readable.less
CROOGO_RESPONSIVE_LESS = ./webroot/less/readable-responsive.less

CSS_DIR=$(CURDIR)/webroot/css
JS_DIR=$(CURDIR)/webroot/js
FONT_DIR=$(CURDIR)/webroot/font

CROOGO_CSS=readable.css
CROOGO_RESPONSIVE_CSS=readable-responsive.css
